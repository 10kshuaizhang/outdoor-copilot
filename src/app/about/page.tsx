  ...
  return (
    <main className="app-atmosphere min-h-dvh text-[var(--ink)]">
      <div className="mx-auto w-full max-w-lg px-5 py-8">
        ...
        <ol className="mt-8 space-y-4 text-base leading-relaxed text-[var(--ink-soft)]">
          {[
            {
              title: "1. 选线",
            ...
            {
              title: "3. 完善或跳过档案",
              body: "填写经验、舒适距离/爬升与风险偏好（生理数据可选），得到 Personal Difficulty、时长区间、挑战路段与出发建议。",
            },
            {
              title: "4. 分享到小红书",
            ...
            <li key={step.title} className="panel px-4 py-4">
